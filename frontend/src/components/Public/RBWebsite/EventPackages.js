...
const EventPackages = () => {
  ...
  const packages = [
    ...
    // =========================
    {
      ...
      details: [
        ...
        "Beer & Wine: Included",
        "Freshly Made Chasers & Mixers: Pineapple, Cranberry, Grapefruit, Orange Juice, Sour, Coke, Sprite, Ginger Ale, Ginger Beer, Tonic Water, Club Soda, Water",
  ...
  return (
    <div className="event-packages">
      <PageSEO
        seo={seo}
        fallbackTitle="Event Bartending Packages in Miami | Ready Bartending"
        fallbackDescription="Compare professional bartender staffing and mobile bar packages for weddings, private parties, and corporate events in South Florida."
        fallbackUrl="https://readybartending.com/rb/event-staffing-packages"
      />
