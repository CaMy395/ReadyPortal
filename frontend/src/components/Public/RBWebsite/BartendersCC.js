...
const BartendingCourses = () => {
  ...
  if (loading) return <div className="bartending-page">Loading...</div>;

  return (
    <div className="bartending-page">

      {/* ✅ SEO */}
      <Helmet>
        <title>{seo?.seo_title || "Bartending Course in Miami | Ready Bartending"}</title>
      ...
      <section className="why-choose-us">
        ...
        <p>
          Disclaimer: This class does not use real alcohol as we will be making mocktails.
          See our <Link to="/rb/mix-n-sip" className="link-style">Mix N Sip</Link> class or our <Link to="/rb/craft-cocktails" className="link-style">Crafts & Cocktails</Link> class to learn how to make real cocktails.
        </p>
      ...
      <section className="why-choose-us">
        ...
        <p>When you enroll in The Ready Bar Course, you'll receive a complete Ready Bartending Bar Kit</p>
        ...
        <ul>
          ...
          <li>A State Issued Bartending Certificate</li>
      ...
      <section className="why-choose-us">
        ...
        <ul>
          ...
          <li>You will receive your certification regardless of scores.</li>
