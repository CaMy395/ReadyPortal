...
const Register = () => {
  ...
  // Track W-9 status; required only for staff ("user")
  ...
  // Only staff require W9. Students can agree without it.
  const termsCheckboxDisabled = formData.role === 'user' && !w9Uploaded;
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>
            ...
            <select name="role" value={formData.role} onChange={(e) => {
              // If the user switches from 'user' to 'student', we don't need W9 anymore.
              if (e.target.value === 'student') {
                // Keep any previous W9 state in case they switch back, but it won't be required
              }
              handleChange(e);
            }}>
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <ul>
              ...
              <li>✅ Upload your ID in the Terms (all registrants).</li>
              <li>✅ <strong>Staff only:</strong> upload your W‑9 to unlock the agreement box.</li>
              <li>✅ Check the agreement box once done.</li>
